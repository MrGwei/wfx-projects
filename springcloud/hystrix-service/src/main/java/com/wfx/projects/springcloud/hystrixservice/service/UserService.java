package com.wfx.projects.springcloud.hystrixservice.service;
...
import com.wfx.projects.springcloud.hystrixservice.pojo.Result;
import com.wfx.projects.springcloud.hystrixservice.pojo.User;
...
public class UserService {
    ...
    public Result fallbackMethod2(@PathVariable Long id, Throwable t) {
        LOGGER.error("id {}, throwable class:{}", id, t.getClass());
        return new Result("服务调用失败", 500);
    }
